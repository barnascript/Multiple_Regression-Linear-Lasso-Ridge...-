...
class RegressionTree:
    def __init__(self, 
        ...
        #node type
        self.node.type = node_type if node_type else "root"
        ...
        #initializing the left ad right node
        self.left = None
        self.right = None
    ...
    #calculating the best features and best value to plit the node for decision tree

    def best_split_calculator(self):
        best_feature, best_value = None, None

        #creation of a dataframe combinig X and y
        df = self.X.copy()
        df["y"] = self.y
        ...
        for feature in self.features:
            ...
            for value in x_mean:
                ...
                #calculating the mean and residulas for left and right subtrees
...
if __name__ == "__main__":
     ...
     #splitting the data into trainigna testing
     X_train,X_test, y_train, y_test = data_preprocessing(csv_path)
